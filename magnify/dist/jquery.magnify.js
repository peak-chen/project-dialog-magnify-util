...
Magnify.prototype = {
  ...
  init: function (el, options) {
    ...
    if (this.options.showMagnify) {
        //是否显示图片的放大镜效果
        supportShowMagnify(this.options.showMagnify);
        this.showMagnify(this.$stage, this.$image,this);
    }
  ...
  setModalPos: function (modal) {
    ...
    if(this.options.showMagnify){
        supportShowMagnify(!this.options.initMaximized);
    }
  ...
  jumpTo: function (index) {
    ...
    if (this.isMaximized) {
        //去除放大镜显示效果
        this.$large.removeClass('magnify-large');
    }else{
      if(this.options.showMagnify){
          //给large赋背景图
          this.showMagnify(this.$stage, this.$image,this);
...
//显示放大镜效果
var showMagnify = function (stage, image,initThis) {
    ...
    $(".magnify-modal").mousemove(function (e) {
        ...
        if (!native_width && !native_height) {
            ...
            //给large赋背景图
            $large.css("background-image","url("+image.attr('src')+")");
    ...
    //当鼠标离开图片时去除放大镜样式
    $(".magnify-modal").mouseleave(function(){
        //去除放大镜显示效果
        initThis.$large.removeClass('magnify-large');
    });
    //当鼠标在图片时新增放大镜样式
    $(".magnify-modal").mouseenter(function(){
        if (!initThis.isMaximized) {
            //新增放大镜显示效果
            initThis.$large.addClass('magnify-large');
        }
    });
...
// Add to Magnify Prototype
  ...
  function supportShowMagnify(flag){
      $(".magnify-large").css("display",function(flag){
          return flag ? "":"none";
      });
  }
